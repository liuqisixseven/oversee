...
public class WebMvcConfiguration implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        String upLoadPath=chdBaseConfig.getPath().getUpload();
        String webAppPath=chdBaseConfig.getPath().getWebapp();
...
//    {
////		return getAdminfile() + "/download/";
//        return getUploadPath() + "/download/";
//    }

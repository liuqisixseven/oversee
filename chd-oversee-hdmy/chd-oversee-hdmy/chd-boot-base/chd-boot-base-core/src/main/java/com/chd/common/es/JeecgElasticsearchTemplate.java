...
import com.chd.common.util.RestUtil;
...
public class JeecgElasticsearchTemplate {
    ...
    public JeecgElasticsearchTemplate(ElasticsearchProperties elasticsearchProperties) {
         String baseUrl=elasticsearchProperties.getBaseUrl();
          boolean checkEnabled=elasticsearchProperties.getCheckEnabled();

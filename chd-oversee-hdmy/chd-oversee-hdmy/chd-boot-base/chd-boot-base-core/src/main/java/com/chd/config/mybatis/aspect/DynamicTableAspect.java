package com.chd.config.mybatis.aspect;
...
import com.chd.common.aspect.annotation.DynamicTable;
import com.chd.common.constant.CommonConstant;
import com.chd.common.util.SpringContextUtils;
import com.chd.config.mybatis.ThreadLocalDataHelper;
...
public class DynamicTableAspect {
     ...
     * 定义切面拦截切入点
     */
    @Pointcut("@annotation(com.chd.common.aspect.annotation.DynamicTable)")

...
import com.chd.common.util.filter.FileTypeFilter;
import com.chd.common.util.filter.StrAttackFilter;
...
public class MinioUtil {
    ...
    public static String upload(File file, String bizPath, String customBucket) {
        String fileUrl = "";
        String newBucket = bucketName;
        if(oConvertUtils.isNotEmpty(customBucket)){
            newBucket = customBucket;

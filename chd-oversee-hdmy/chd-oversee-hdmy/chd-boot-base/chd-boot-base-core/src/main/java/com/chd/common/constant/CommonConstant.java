...
public interface CommonConstant {
    ...
    String DEFAULT_SYS_ROLE_CODE = "admin";
    String USERNAME_ROLES_PREFIX = "username::roles";
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:com.chd.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
...
//    int  TOKEN_EXPIRE_TIME  = 3600;
    ...
    */
    ...
    /**通告对象类型（USER:指定用户，ALL:全体用户, DEPART指定部门）*/
    String MSG_TYPE_UESR  = "USER";
    String MSG_TYPE_ALL  = "ALL";

    String MSG_TYPE_DEPART  = "DEPART";
    ...
    String TOKEN_IS_INVALID_MSG = "身份信息校验失败!";

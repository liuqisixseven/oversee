package com.chd.config.sign.interceptor;
...
import com.chd.config.sign.util.BodyReaderHttpServletRequestWrapper;
...
public class SignAuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if(StringUtil.isEmpty(xTimestamp)){
            xTimestamp = request.getParameter(CommonConstant.X_TIMESTAMP);
        }
        //客户端时间

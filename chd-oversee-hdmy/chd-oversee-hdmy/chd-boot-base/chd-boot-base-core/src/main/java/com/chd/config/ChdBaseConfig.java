...
import com.chd.config.vo.DomainUrl;
import com.chd.config.vo.Path;
import com.chd.config.vo.Shiro;
 ...
 */
@Component
@ConfigurationProperties(prefix = "chd")
public class ChdBaseConfig {
    /**
     * 签名密钥串(字典等敏感接口)

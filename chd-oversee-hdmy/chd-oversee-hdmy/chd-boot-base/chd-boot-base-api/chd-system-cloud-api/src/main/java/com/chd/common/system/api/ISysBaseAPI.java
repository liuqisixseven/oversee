package com.chd.common.system.api;
...
import com.chd.common.system.api.factory.SysBaseAPIFallbackFactory;
 ...
 * 2、@ConditionalOnMissingClass("com.chd.modules.system.service.impl.SysBaseApiImpl")=> 有实现类的时候，不实例化Feign接口
 * 
 */
@Component
...
@ConditionalOnMissingClass("com.chd.modules.system.service.impl.SysBaseApiImpl")

...
import com.chd.common.system.vo.DictQuery;
import com.chd.common.system.vo.LoginUser;
import com.chd.common.util.ImportExcelUtil;
import com.chd.common.util.SqlInjectionUtil;
import com.chd.common.util.oConvertUtils;
import com.chd.modules.system.entity.SysDict;
import com.chd.modules.system.entity.SysDictItem;
import com.chd.modules.system.model.SysDictTree;
import com.chd.modules.system.model.TreeSelectModel;
import com.chd.modules.system.security.DictQueryBlackListHandler;
import com.chd.modules.system.service.ISysDictItemService;
import com.chd.modules.system.service.ISysDictService;
import com.chd.modules.system.vo.SysDictPage;
...
public class SysDictController {
	...
	@RequestMapping(value = "/getSystemNameList", method = RequestMethod.GET)
	public Result<List<DictModel>> getSystemNames(SysDict sysDict,HttpServletRequest req) {
		Result<List<DictModel>> result = new Result<List<DictModel>>();
		List<DictModel> dictItems = sysDictService.getDictItems(BaseConstant.SYSTEM_NAME_DICT_KEY);
		result.setSuccess(true);

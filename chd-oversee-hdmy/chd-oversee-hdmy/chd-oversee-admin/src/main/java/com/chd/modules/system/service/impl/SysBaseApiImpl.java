...
import com.chd.common.api.dto.OnlineAuthDTO;
import com.chd.common.api.dto.message.*;
import com.chd.common.aspect.UrlMatchEnum;
import com.chd.common.constant.*;
import com.chd.common.constant.enums.MessageTypeEnum;
import com.chd.common.desensitization.util.SensitiveInfoUtil;
...
import com.chd.common.system.vo.*;
import com.chd.common.util.SysAnnmentTypeEnum;
import com.chd.common.util.YouBianCodeUtil;
import com.chd.common.util.dynamic.db.FreemarkerParseFactory;
import com.chd.common.util.oConvertUtils;
import com.chd.modules.message.entity.SysMessageTemplate;
import com.chd.modules.message.handle.impl.DdSendMsgHandle;
import com.chd.modules.message.handle.impl.EmailSendMsgHandle;
import com.chd.modules.message.handle.impl.QywxSendMsgHandle;
import com.chd.modules.message.handle.impl.SystemSendMsgHandle;
import com.chd.modules.message.service.ISysMessageTemplateService;
import com.chd.modules.message.websocket.WebSocket;
...
//			}
	...
	@Override
	public SysUserCacheInfo getSysUserById(String id) {
...
//		}
			...
			if(user!=null) {
				...
				info.setSysUserName(user.getRealname());
				info.setSysOrgCode(user.getOrgCode());
				info.setHdmyUserId(user.getHdmyUserId());
				info.setHdmyOrgId(user.getHdmyOrgId());
	...
	@Override
	public SysUserCacheInfo getSysUserByHdmyId(String hdmyUserId) {
		List<SysUser> sysUserList = sysUserService.list(Wrappers.<SysUser>lambdaQuery().eq(SysUser::getHdmyUserId, hdmyUserId));
	...
	@Override
	public SysDepartModel getSysDepartById(String id) {

		SysDepart sysDepartById = sysDepartService.getById(id);
		if(null!=sysDepartById){
			SysDepartModel sysDepartModel = new SysDepartModel();
			BeanUtils.copyProperties(sysDepartById, sysDepartModel);
			return sysDepartModel;
		}

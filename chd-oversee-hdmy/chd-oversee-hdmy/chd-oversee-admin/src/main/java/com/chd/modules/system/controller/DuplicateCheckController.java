...
import com.chd.modules.system.security.SecurityWhiteList;
...
import com.chd.modules.system.model.DuplicateCheckVo;
...
public class DuplicateCheckController {
	...
	public Result<String> doDuplicateCheck(DuplicateCheckVo duplicateCheckVo, HttpServletRequest request) {
		...
		if(!SecurityWhiteList.canDuplicateCheck(duplicateCheckVo.getTableName(),duplicateCheckVo.getFieldName())){

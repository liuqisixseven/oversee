package com.chd.modules.api.controller;
...
public class SystemApiController {
    ...
    @ApiOperation(value = "发送消息-附带业务参数", notes = "发送消息 附带业务参数")
    ...
    @ApiOperation(value = "通过模板发送消息", notes = "通过模板发送消息")
    ...
    @ApiOperation(value = "通过模板发送消息-附带业务参数", notes = "通过模板发送消息 附带业务参数")
    ...
    @ApiOperation(value = "通过消息中心模板，生成推送内容", notes = "通过消息中心模板，生成推送内容")
    ...
    @ApiOperation(value = "根据业务类型busType及业务busId修改消息已读", notes = "根据业务类型busType及业务busId修改消息已读")
    ...
    @ApiOperation(value = "通过用户账号查询角色集合", notes = "通过用户账号查询角色集合")
    ...
    @ApiOperation(value = "通过用户账号查询部门集合", notes = "通过用户账号查询部门集合")
    ...
    @ApiOperation(value = "通过用户账号查询部门 name", notes = "通过用户账号查询部门 name")
    ...
    @ApiOperation(value = "查询所有的父级字典", notes = "查询所有的父级字典")
...
//        }
    ...
    @ApiOperation(value = "查询所有分类字典", notes = "查询所有分类字典")
    ...
    @ApiOperation(value = "查询所有部门 作为字典信息", notes = "查询所有部门 作为字典信息")
    ...
    @ApiOperation(value = "获取所有角色 带参", notes = "获取所有角色 带参")
    ...
    @ApiOperation(value = "通过用户账号查询角色Id集合", notes = "通过用户账号查询角色Id集合")
    ...
    @ApiOperation(value = "通过部门编号查询部门id", notes = "通过部门编号查询部门id")
    ...
    @ApiOperation(value = "根据 id 查询数据库中存储的 DynamicDataSourceModel", notes = "根据 id 查询数据库中存储的 DynamicDataSourceModel")
    ...
    @ApiOperation(value = "根据部门Id获取部门负责人", notes = "根据部门Id获取部门负责人")
    ...
    @ApiOperation(value = "查找父级部门", notes = "查找父级部门")

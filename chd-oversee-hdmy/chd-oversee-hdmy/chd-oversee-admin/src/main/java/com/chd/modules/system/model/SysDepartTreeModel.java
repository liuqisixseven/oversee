package com.chd.modules.system.model;
...
public class SysDepartTreeModel implements Serializable{
	...
	public SysDepartTreeModel(SysDepart sysDepart) {
        ...
        this.upperSupervisorId = sysDepart.getUpperSupervisorId();
        this.upperSupervisorName = sysDepart.getUpperSupervisorName();
        this.fullName = sysDepart.getFullName();
        this.shortName = sysDepart.getShortName();
    }
    ...
    public void setUpperSupervisorId(String upperSupervisorId) {
        this.upperSupervisorId = upperSupervisorId;
    }
    ...
    public void setUpperSupervisorName(String upperSupervisorName) {
        this.upperSupervisorName = upperSupervisorName;
    }

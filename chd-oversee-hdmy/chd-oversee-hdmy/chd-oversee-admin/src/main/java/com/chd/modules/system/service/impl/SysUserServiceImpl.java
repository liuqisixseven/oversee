...
import com.chd.common.constant.enums.RoleIndexConfigEnum;
import com.chd.common.desensitization.annotation.SensitiveEncode;
import com.chd.common.system.vo.LoginUser;
import com.chd.common.system.vo.SysUserCacheInfo;
import com.chd.common.util.PasswordUtil;
...
import com.chd.modules.system.vo.SysUserDepVo;
...
//		this.save(user);  //保存角色的时候已经添加过一次了
	...
	public boolean isSuperUser(String userId) {
		...
		if(sysUser!=null && sysUser.getStatus()!=null && sysUser.getStatus()==1){
			...
			query.eq("role_id","superuser");//直接指定超级用户的角色ID
			query.eq("user_id",userId);
			 SysUserRole one = sysUserRoleMapper.selectOne(query);
			 if(one!=null) {
				 return true;
			 }
		}
	...
	@Override
	public IPage<SysUser> selectSysUserPageVo(Page<?> page, Map<String, Object> map) {
		return userMapper.selectSysUserPageVo(page,map);
	}
}

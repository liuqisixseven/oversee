...
public class SysAnnouncementSendController {
	 ...
	 * @return
	 */
	@GetMapping(value = "/queryUserListByRead")
	@ApiOperation(value = "获取已读的消息用户列表", notes = "获取已读的消息用户列表")
	public Result<List<SysUser>> queryUserListByRead(
			@RequestParam(name="anntId", defaultValue="1584753602301833218") String anntId) {
		Result<List<SysUser>> result = new Result<List<SysUser>>();
		result.setResult(sysAnnouncementSendService.queryUserListByRead(anntId));
		result.setSuccess(true);
		return result;
	}
...
//	  * @return
//	  */
//	 @PostMapping(value = "/queryUserListByNotRead")
//	 @ApiOperation(value = "获取未读的消息用户列表", notes = "获取未读的消息用户列表")
//	 public Result<List<SysUser>> queryUserListByNotRead(SysAnnouncement sysAnnouncement) {
//		 Result<List<SysUser>> result = new Result<List<SysUser>>();
//		 result.setResult(sysAnnouncementSendService.queryUserListByRead(anntId));
//		 result.setSuccess(true);
//		 return result;
...
//		announcementSendModel.setHdmyOrgId(sysUser.getHdmyOrgId());

...
public interface ISysDepartService extends IService<SysDepart>{
    ...
    /**
     * 根据parentOrgIds查询所有部门和子部门信息,并分节点进行显示
     * @param parentOrgIds 多个部门id
     * @return
     */
    List<SysDepartTreeModel> queryTreeListByParentOrgIds(String parentOrgIds);
    ...
    List<SysDepartTreeModel> queryTreeListByPid(String parentId, String ids, String primaryKey, List<String> pathList);

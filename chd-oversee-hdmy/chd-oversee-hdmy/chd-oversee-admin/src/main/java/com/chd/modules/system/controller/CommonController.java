...
public class CommonController {
     ...
     * @return
     */
    @PostMapping(value = "/authorizeUpload")
    public Result<?> authorizeUpload(HttpServletRequest request, HttpServletResponse response) {
        Result<?> result = new Result<>();
        String savePath = "";
        String bizPath = request.getParameter("biz");
...
//	}
    ...
    public void view(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!FileUtils.checkAllowDownload(imgPath)) {
            throw new BizException(StrFormatter.format("资源文件({})非法，不允许下载。 ", imgPath));
        }
        // 其余处理略
        ...
        try {
            ...
            FileUtils.writeBytes(filePath, response, MediaType.APPLICATION_OCTET_STREAM_VALUE);

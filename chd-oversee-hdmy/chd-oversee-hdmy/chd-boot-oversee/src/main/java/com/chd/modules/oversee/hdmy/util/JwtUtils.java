...
public class JwtUtils {
    ...
    public static String getJwtToken(JwtInfo jwtInfo, int expire){
        ...
        String JwtToken = Jwts.builder()
                ...
                .claim("user_id", jwtInfo.getUser_id())//用户id
                .claim("user_name", jwtInfo.getUser_name())//用户昵称
    ...
    public static JwtInfo getMemberIdByJwtToken(HttpServletRequest request) {
        ...
        JwtInfo jwtInfo = new JwtInfo(claims.get("user_id").toString(), claims.get("user_name").toString());
        return jwtInfo;
    }
}

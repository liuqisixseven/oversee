 ...
 */
@Data
@TableName("oversee_issue_category")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="oversee_issue_category对象", description="oversee_issue_category")
public class OverseeIssueCategory implements Serializable {

  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="具体问题内容" v-bind="validateInfos.specificIssuesContent">
	          <a-textarea v-model:value="formData.specificIssuesContent" rows="4" placeholder="请输入具体问题内容" :disabled="disabled"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../SpecificIssues.api';

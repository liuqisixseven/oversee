    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="具体问题内容" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="specificIssuesContent">
              <a-textarea v-model="model.specificIssuesContent" rows="4" placeholder="请输入具体问题内容" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/issue/specificIssues/add",
          edit: "/issue/specificIssues/edit",
          queryById: "/issue/specificIssues/queryById"
        }
      }
    },
    computed: {

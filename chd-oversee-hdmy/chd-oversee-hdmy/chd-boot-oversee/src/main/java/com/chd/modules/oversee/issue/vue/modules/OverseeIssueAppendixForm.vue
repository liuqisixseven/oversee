  ...
  <a-spin :spinning="confirmLoading">
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          <a-col :span="24">
            <a-form-model-item label="附件路径地址" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="appendixPath">
              <a-input v-model="model.appendixPath" placeholder="请输入附件路径地址"  ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="附件类型 1 问题录入 2问题分配 3整改措施" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="type">
              <a-input-number v-model="model.type" placeholder="请输入附件类型 1 问题录入 2问题分配 3整改措施" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="文件类型 0 无 1图片 2pdf 此字段不一定启用" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="fileType">
              <a-input-number v-model="model.fileType" placeholder="请输入文件类型 0 无 1图片 2pdf 此字段不一定启用" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/issue/overseeIssueAppendix/add",
          edit: "/issue/overseeIssueAppendix/edit",
          queryById: "/issue/overseeIssueAppendix/queryById"
        }
      }
    },
    computed: {
